...
import com.example.teec3.githubprofileviewer.utilities.GithubJsonUtils;
import com.example.teec3.githubprofileviewer.utilities.NetworkUtils;
    ...
    private class GithubQueryTask extends AsyncTask<URL, Void, ArrayList<User>> {
        ...
        protected ArrayList<User> doInBackground(URL... urls) {
            ...
            try {
                ...
                usersList = GithubJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, githubSearchResults);
